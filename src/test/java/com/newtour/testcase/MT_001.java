...
public class MT_001 extends BaseClass {
	...
	public void FindFlight() {
		...
		// String currenturl="http://newtours.demoaut.com/mercurypurchase2.php";
		String act_url = driver.getCurrentUrl();
		// Assert.assertEquals(currenturl,driver.getCurrentUrl());
		Assert.assertTrue(act_url.contains("mercurypurchase"));

		// Assertion of flight confirmation page
		WebElement flight = driver.findElement(By.xpath("//font[contains(text(),'Your')]"));
		String flight_conf = flight.getText();
		System.out.println(flight_conf);
		Assert.assertTrue(flight_conf.contains("itinerary"));
